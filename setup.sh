...
#RA: manually fetch maven 3.8.5 instead of using default 3.5.0 package
cd /autograder
wget https://mirror.olnevhost.net/pub/apache/maven/maven-3/3.8.5/binaries/apache-maven-3.8.5-bin.tar.gz
tar xzvf apache-maven-3.8.5-bin.tar.gz

#RA: install jh61b manually
cd /autograder/source
export PATH="/autograder/apache-maven-3.8.5/bin:$PATH"
